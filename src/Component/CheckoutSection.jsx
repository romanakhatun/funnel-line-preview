        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-10 max-w-sm rounded-2xl shadow-lg overflow-hidden bg-white">
              ...
              <div className="relative bg-yellow-400 text-white text-center py-3 font-medium after:content-[''] after:absolute after:-top-3.75 after:left-[20%] after:w-0 after:h-0 after:border-l-15 after:border-l-transparent after:border-r-15 after:border-r-transparent after:border-b-15 after:border-b-[#facc15]">
          ...
          <div>
            ...
            <div className="border border-gray-300 rounded-xl p-6 space-y-6">
              ...
              <div className="flex justify-between items-center gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 bg-orange-200 rounded-md flex items-center justify-center text-xs">
                    <Image
                      src="/product.svg"
                      alt="Product"
                      width={47}
              ...
              <div className="border-t pt-4 space-y-2 flex justify-between">
            ...
            <button className="mt-8 w-full bg-yellow-400 hover:bg-yellow-500 transition text-white font-semibold py-4 rounded-xl flex items-center justify-center gap-2 text-lg">
              <IoCartOutline size={25} /> Place Order BDT 1,690.00
            </button>
          </div>
        </div>
      </div>
