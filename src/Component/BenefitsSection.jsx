      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {items.map((item, index) => (
            <div
              key={index}
              className="bg-[#fff9e8] border-2 border-[#fff9e8] rounded-[15px] outline-2 outline-[#f9be20] outline-offset-[-11px] p-6 text-center shadow-sm hover:shadow-md transition"
            >
              <h3 className="text-xl font-bold text-[#0a2c1a] mb-4">
                {item.title}
              </h3>
